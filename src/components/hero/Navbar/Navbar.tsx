                            ...
                            pathname === "/" ? (
                                ...
                                <div className="relative email-dropdown-container">
                                    <button
                                        ...
                                        className="flex items-center gap-2.5 px-4 py-2 rounded-full border border-slate-200 bg-white/60 backdrop-blur-md text-slate-700 font-semibold text-sm transition hover:bg-white/90 shadow-sm cursor-pointer select-none"
                                    >
                                        <div className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center shrink-0 border border-slate-200">
                                            <User size={16} className="text-slate-500 fill-slate-500" />
                                        </div>
                                        <span className="font-semibold text-slate-700 tracking-wide max-w-[200px] truncate">
