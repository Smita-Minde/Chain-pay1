...
export default function AboutPage() {
  return (
    <main className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-white">
      ...
      {/* Hero */}
      <section className="max-w-7xl mx-auto px-6 lg:px-10 py-12 lg:py-1">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center lg:items-start">
          ...
          <div className="relative z-10 lg:pt-0">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Link href="/login" className="px-8 py-3 rounded-full bg-blue-600 text-white font-semibold hover:bg-blue-700 shadow-lg shadow-blue-200 hover:shadow-xl transition-all">
                Get Started
              </Link>
            </div>
          </div>
          ...
          <div className="relative z-10 group mt-5">
            ...
            <div className="absolute -inset-4 bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 rounded-[32px] sm:rounded-[40px] blur-2xl opacity-20 group-hover:opacity-30 transition-opacity duration-500" />

            <div className="relative bg-white/90 backdrop-blur-xl border border-white/60 rounded-[32px] sm:rounded-[40px] p-5 sm:p-8 lg:p-10 shadow-2xl overflow-hidden group-hover:shadow-3xl transition-all duration-500">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 mb-8">
                ...
                <div className="group/card relative bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-2xl sm:rounded-[24px] p-5 sm:p-6 border border-blue-200/30 hover:-translate-y-1 hover:shadow-lg transition-all cursor-default">
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-400/0 to-blue-500/0 group-hover/card:from-blue-400/5 group-hover/card:to-blue-500/10 rounded-2xl sm:rounded-[24px] transition-all" />
                ...
                <div className="group/card relative bg-gradient-to-br from-green-50 to-emerald-100/50 rounded-2xl sm:rounded-[24px] p-5 sm:p-6 border border-green-200/30 hover:-translate-y-1 hover:shadow-lg transition-all cursor-default">
                  <div className="absolute inset-0 bg-gradient-to-br from-green-400/0 to-green-500/0 group-hover/card:from-green-400/5 group-hover/card:to-green-500/10 rounded-2xl sm:rounded-[24px] transition-all" />
                ...
                <div className="group/card relative bg-gradient-to-br from-purple-50 to-purple-100/50 rounded-2xl sm:rounded-[24px] p-5 sm:p-6 border border-purple-200/30 hover:-translate-y-1 hover:shadow-lg transition-all cursor-default">
                  <div className="absolute inset-0 bg-gradient-to-br from-purple-400/0 to-purple-500/0 group-hover/card:from-purple-400/5 group-hover/card:to-purple-500/10 rounded-2xl sm:rounded-[24px] transition-all" />
                ...
                <div className="group/card relative bg-gradient-to-br from-orange-50 to-amber-100/50 rounded-2xl sm:rounded-[24px] p-5 sm:p-6 border border-orange-200/30 hover:-translate-y-1 hover:shadow-lg transition-all cursor-default">
                  <div className="absolute inset-0 bg-gradient-to-br from-orange-400/0 to-orange-500/0 group-hover/card:from-orange-400/5 group-hover/card:to-orange-500/10 rounded-2xl sm:rounded-[24px] transition-all" />
            ...
            <div className="mt-3 flex justify-end">
              <div className="max-w-xl rounded-2xl sm:rounded-[28px] border border-slate-200/80 bg-white/90 p-3 sm:p-2 shadow-xl backdrop-blur-xl">
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-10 py-24 relative">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="group relative">
            <div className="absolute inset-0 bg-gradient-to-br from-blue-500 via-indigo-500 to-cyan-400 rounded-2xl sm:rounded-[32px] blur-xl opacity-30 group-hover:opacity-40 transition-all duration-700 -z-10" />

            <div className="relative overflow-hidden rounded-2xl sm:rounded-[32px] border border-blue-200/40 bg-gradient-to-br from-blue-50/80 via-slate-50/80 to-cyan-50/80 backdrop-blur-xl p-6 sm:p-10 lg:p-12 shadow-xl transition-all duration-500 group-hover:shadow-2xl group-hover:border-blue-200/60">
          ...
          {/* Mission Card */}
          <div className="group relative">
            <div className="absolute inset-0 bg-gradient-to-br from-pink-500 via-rose-500 to-red-400 rounded-2xl sm:rounded-[32px] blur-xl opacity-30 group-hover:opacity-40 transition-all duration-700 -z-10" />

            <div className="relative overflow-hidden rounded-2xl sm:rounded-[32px] border border-pink-200/40 bg-gradient-to-br from-pink-50/80 via-slate-50/80 to-rose-50/80 backdrop-blur-xl p-6 sm:p-10 lg:p-12 shadow-xl transition-all duration-500 group-hover:shadow-2xl group-hover:border-pink-200/60">
      ...
      <section className="py-16 sm:py-24">
        <div className="max-w-6xl mx-auto px-6">
          <div className="relative overflow-hidden rounded-3xl sm:rounded-[40px] border border-slate-200/70 bg-white/95 shadow-[0_20px_80px_rgba(15,23,42,0.08)]">
            ...
            <div className="relative px-5 py-12 sm:px-8 sm:py-16 md:px-12 md:py-20">
              ...
              <div className="grid gap-6 md:grid-cols-2">
                {[
                  ...
                  <div key={item.title} className="group relative overflow-hidden rounded-2xl sm:rounded-[32px] border border-slate-200/80 bg-slate-50/80 p-6 sm:p-8 shadow-sm transition duration-500 hover:-translate-y-2 hover:shadow-2xl">
                    <div className="absolute inset-0 rounded-2xl sm:rounded-[32px] bg-gradient-to-br from-blue-500/0 via-purple-500/0 to-pink-500/0 opacity-0 transition duration-500 group-hover:opacity-20" />
                    ...
                    <h3 className="relative z-10 text-xl sm:text-2xl font-semibold text-slate-900 mb-3">{item.title}</h3>
      ...
      <section className="pb-24 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative overflow-hidden rounded-3xl sm:rounded-[40px]">
            ...
            <div className="relative p-8 sm:p-16 lg:p-24 text-center text-white">
              ...
              <Link href="/login" className="mt-10 inline-flex items-center justify-center px-10 py-4 bg-white text-blue-600 rounded-xl font-semibold hover:scale-105 transition">
                Get Started
              </Link>
