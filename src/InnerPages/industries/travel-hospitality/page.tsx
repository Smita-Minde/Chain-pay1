                    ...
                    <div className="relative flex justify-center lg:justify-end w-full">
                        ...
                        <div className="relative w-full max-w-lg min-h-[460px] flex items-center justify-center">
                            ...
                            <motion.div
                                ...
                                className="w-full max-w-[380px] bg-white border border-[#E2E8F0] shadow-2xl rounded-3xl overflow-hidden relative z-35 hover:shadow-[0_30px_70px_-10px_rgba(0,0,0,0.06)] hover:border-blue-400/15 transition-all duration-300"
                                    ...
                                    <div className="flex items-center justify-between p-3 bg-[#F8FAFC] rounded-2xl border border-[#E2E8F0] shadow-sm">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="text-left">
                                                <h4 className="font-extrabold text-xs text-[#0F172A]">Grand Resort Room 402</h4>
                                                <p className="text-[10px] text-[#64748B] font-semibold">Includes 7-nights deposit</p>
                                            </div>
                                        </div>
                                        <div className="text-right">
                                            <span className="text-xs font-black text-[#0F172A]">$1,450.00</span>
                                        </div>
                                    </div>
                                        ...
                                        <AnimatePresence mode="wait">
                                            ...
                                            {checkoutStep === 4 && (
                                                ...
                                                >
                                                    ...
                                                    <div>
                                                        <h5 className="font-black text-base text-[#0F172A]">Booking Confirmed!</h5>
                                                    ...
                                                    <div className="p-3 bg-slate-50 border border-slate-200/80 rounded-2xl max-w-xs mx-auto text-[11px] space-y-1.5 text-left relative overflow-hidden">
                                                        ...
                                                        <div className="flex justify-between">
                                                            ...
                                                            <span className="font-mono text-[9px] text-blue-600 truncate max-w-[120px]">ch_8492_hotel</span>
                                                        </div>
                                                    </div>
