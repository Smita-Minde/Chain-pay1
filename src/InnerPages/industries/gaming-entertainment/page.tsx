                                ...
                                <div className="flex items-center justify-between p-4 bg-[#F8FAFC] rounded-2xl border border-[#E2E8F0] shadow-sm">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="text-left">
                                            <h4 className="font-extrabold text-sm text-[#0F172A]">Epic Dragon Sword + 500 XP</h4>
                                            <p className="text-[11px] text-[#64748B] font-semibold">Store: Nexus Esports Market</p>
                                        </div>
                                    </div>
                                    <div className="text-right">
                                        <span className="text-sm font-black text-[#0F172A]">$45.00</span>
                                    </div>
                                </div>
                                    ...
                                    <AnimatePresence mode="wait">
                                        ...
                                        {checkoutStep === 1 && (
                                            ...
                                            >
                                                ...
                                                <div className="space-y-1">
                                                    ...
                                                    <p className="text-xs text-[#64748B]">Setting up secure in-game payments path...</p>
                                                </div>
                                                <button
                                            ...
                                            >
                                                ...
                                                <div className="flex flex-col sm:flex-row gap-5 items-center p-1 bg-slate-50/30 rounded-2xl border border-slate-100">
                                                    ...
                                                    <div className="space-y-3 text-left w-full">
                                                        <div>
                                                            <p className="text-[10px] font-bold text-[#64748B] uppercase tracking-wider">Receiver Wallet</p>
                                        ...
                                        {checkoutStep === 3 && (
                                            ...
                                            >
                                                ...
                                                <div className="space-y-1">
                                                    <h5 className="font-extrabold text-sm text-[#0F172A]">Transaction Detected</h5>
                                        ...
                                        {checkoutStep === 4 && (
                                            ...
                                            >
                                                ...
                                                <div>
                                                    <h5 className="font-black text-lg text-[#0F172A]">Payment Confirmed!</h5>
                                                    <p className="text-xs text-emerald-600 font-semibold">In-Game Asset Dispatched</p>
                                                </div>
                                                ...
                                                <div className="p-4 bg-slate-50 border border-slate-200/80 rounded-2xl max-w-xs mx-auto text-xs space-y-2 text-left relative overflow-hidden">
                                                    ...
                                                    <div className="flex justify-between">
                                                        ...
                                                        <span className="font-mono text-[10px] text-blue-600 truncate max-w-[130px]">0x3b8d99...a3e1</span>
                                                    </div>
                                                </div>
