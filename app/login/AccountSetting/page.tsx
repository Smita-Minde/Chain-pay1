...
export default function AccountSettingPage() {
    const [activeView] = useState<'home' | 'transaction' | 'payout' | 'settings'>('settings');
                            ...
                            <div className="grid gap-6 md:grid-cols-2">
                                ...
                                <div className="rounded-3xl border border-white/40 bg-white/60 p-6 shadow-xl backdrop-blur-md flex flex-col justify-between">
                                    ...
                                    <button
                                        ...
                                        className="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl text-sm transition cursor-pointer shadow-md shadow-blue-500/10"
                                    >
                            ...
                            <div className="grid gap-6 md:grid-cols-2">
                                ...
                                <div className="rounded-3xl border border-white/40 bg-white/60 p-6 shadow-xl backdrop-blur-md">
                                    ...
                                    <p className="text-sm text-slate-500 mb-6 leading-relaxed">
                                        Configure the payment settings for the ChainPay.
                                    </p>
                       ...
                       shadow-md flex items-center justify-center"
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="h-11 w-full bg-white/80 border border-slate-200 rounded-xl px-4 text-sm text-slate-800 outline-none focus:border-blue-500 transition"
                                            />
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <select
                                                ...
                                                className="h-11 w-full bg-white/80 border border-slate-200 rounded-xl px-3 text-sm text-slate-800 outline-none focus:border-blue-500 transition"
                                            >
